...
@section('title', 'Tindak Lanjut KPI')

@section('content')
<div class="container mt-4">
    <h4 class="mb-3">📋 Daftar Tindak Lanjut KPI</h4>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('tindak-lanjut.create') }}" class="btn btn-primary">+ Tambah Tindak Lanjut</a>
    </div>
    ...
    <table class="table table-bordered table-hover align-middle">
        ...
        <tbody>
            @forelse($tindakLanjuts as $key => $tindak)
                <tr>
                    <td>{{ $tindakLanjuts->firstItem() + $key }}</td>
                    ...
                    <td>
                        <span class="badge
                            {{ $tindak->status_tindak_lanjut == 'Sudah' ? 'bg-success' : 'bg-warning' }}">
